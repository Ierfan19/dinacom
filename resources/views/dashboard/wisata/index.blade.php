                                        ...
                                        <div class="toolbox d-flex flex-row align-items-center gap-2">
                                            ...
                                            <div class="d-flex flex-wrap">
                                                <div class="d-flex align-items-center flex-nowrap">
                                                    ...
                                                    <a href="{{ url('admin/wisata/create') }}"
                                                ...
                                                <form action="{{ url('/admin/wisata') }}" method="get">
                                                    <div class="d-flex align-items-center flex-nowrap">
                                                        ...
                                                        <select class="form-control ms-2" name="paginate" id="">
                                                            <option value="10" {{ $paginate == 10 ? 'selected' : '' }}>
                                                                10</option>
                                                            <option value="25" {{ $paginate == 25 ? 'selected' : '' }}>
                                                                25</option>
                                                            <option value="50" {{ $paginate == 50 ? 'selected' : '' }}>
                                                                50</option>
                                                            <option value="100" {{ $paginate == 100 ? 'selected' : '' }}>
                                                                100</option>
                                                        </select>
                                                        <div class="mx-2"></div>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="d-flex col-sm-12">
                                                    ...
                                                    <input type="text" value="{{ Request::get('cari') }}" name="cari"
                                                        class="form-control" placeholder="Cari Wisata.....">
                                                    <div class="col-sm-2"><button type="submit"
                                                            class="me-3 btn btn-info"><i class="bi bi-search"></i></button>
                                                    </div>
                                                </div>
                                                </form>
                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="p-3">
                                                        <img src="{{ asset('/') }}{{ $row->gambar }}"
                                                            style="max-width: 200px;object-fit: cover;height:200px;"
                                                            class="img-fluid" alt="...">
                                                    </div>
                                                </div>
                                                <div class="col-md-8">
