            ...
            <div class="row" style="display: inline-block;width:100%">
                <div class="row">
                    ...
                    <div class="col-xs-3 float-end">
                        <a href="#" class="btn btn-success" onclick="create()">Tambah Admin</a>
                    </div>
                </div>
...
<script>
    function create() {
        $.get("{{url('/admin/admin/create')}}", {}, function(data, status) {
    ...
    function edit(id) {
        $.get("{{url('/admin/admin/edit')}}/" + id, {}, function(data, status) {
