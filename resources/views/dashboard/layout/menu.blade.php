        ...
        <li>
            ...
            <ul>
                ...
                <li> <a href="index2.html">
                        <ion-icon name="ellipse-outline"></ion-icon>Analytics
                    </a>
                </li>
                <li> <a href="index3.html">
                        <ion-icon name="ellipse-outline"></ion-icon>eCommerce
                    </a>
                </li>
            </ul>
        </li>
                ...
                <li class="nav-item dropdown dropdown-user-setting">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
                        ...
                        <div class="user-setting">
                            <img src="{{asset('/dashboard')}}/assets/images/avatars/06.png" class="user-img" alt="">
                        </div>
                    </a>
                        ...
                        <li>
                            <a class="dropdown-item" href="#">
                                <div class="d-flex flex-row align-items-center gap-2">
                                    <img src="{{asset('/dashboard')}}/assets/images/avatars/06.png" alt=""
