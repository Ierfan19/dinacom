                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div class="product-info">
                                        <h6 class="product-name mb-1">{{$row->nama}}</h6>
                                    </div>
                                </div>
                            </td>
                            <td>{{$row->contact}}</td>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3 fs-6">
                                    ...
                                    <a onclick="return confirm('Apa Anda Yakin??')" href="{{url('/admin/produk/hapus')}}/{{$row->id}}" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Delete" aria-label="Delete">
