...
<!-- Mirrored from htmlbeans.com/html/dot/home-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Dec 2022 14:40:54 GMT -->
<head>
	...
	<div id="wrapper">
		...
		<div class="w1">
			...
			<main id="main" role="main">
				...
				<section class="posts-slider" style="background-image: url(images/img68.jpg);">
					<div class="container">
						<div class="row">
				...
				<div id="twocolumns" class="container">
					<div class="row">
						<!-- Content of the page -->
						<div id="content" class="col-xs-12 col-md-8 pull-right">
							<!-- Widget of the page -->
							...
							<section class="posts-blocks">
								...
								<article class="post-block wow fadeInUp" data-wow-delay="0.6s">
									<div class="post-holder">
										<div class="img-holder">
											<a href="single-post.html"><img src="images/img22.jpg" alt="image description"></a>
										</div>
								...
								<article class="post-block wow fadeInUp" data-wow-delay="0.6s">
									<div class="post-holder">
										<div class="img-holder">
											<a href="single-post.html"><img src="images/img23.jpg" alt="image description"></a>
										</div>
										<time datetime="2011-01-12"><a href="#">25th May - Travel</a></time>
								...
								<article class="post-block wow fadeInUp" data-wow-delay="0.6s">
									<div class="post-holder">
										<div class="video-holder">
											...
											<img src="images/img70.jpg" alt="image description">
										</div>
										<time datetime="2011-01-12"><a href="#">25th May - Travel</a></time>
										<h2><a href="single-post.html">I get up in the morning looking for adventure.</a></h2>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscin elit, sed diam nonummy nibh euismod tincidunt...</p>
								...
								<article class="post-block wow fadeInUp" data-wow-delay="0.6s">
									<div class="post-holder">
										<div class="img-holder">
											<a href="single-post.html"><img src="images/img69.jpg" alt="image description"></a>
										</div>
										<time datetime="2011-01-12"><a href="#">25th May - Travel</a></time>
										<h2><a href="single-post.html">Traveling is awesome <br>if you can enjoy.</a></h2>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscin elit, sed diam nonummy nibh euismod tincidunt...</p>
								...
								<article class="post-block wow fadeInUp" data-wow-delay="0.6s">
									<div class="post-holder">
										<div class="img-holder">
											<a href="single-post.html"><img src="images/img25.jpg" alt="image description"></a>
										</div>
										<time datetime="2011-01-12"><a href="#">25th May - Travel</a></time>
										<h2><a href="single-post.html">I get up in the morning looking for adventure.</a></h2>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscin elit, sed diam nonummy nibh euismod tincidunt...</p>
								...
								<article class="post-block wow fadeInUp" data-wow-delay="0.6s">
									<div class="post-holder">
										<div class="img-holder">
											<a href="single-post.html"><img src="images/img26.jpg" alt="image description"></a>
										</div>
										<time datetime="2011-01-12"><a href="#">25th May - Travel</a></time>
										<h2><a href="single-post.html">Traveling is awesome <br>if you can enjoy.</a></h2>
										<p>Lorem ipsum dolor sit amet, consectetuer adipiscin elit, sed diam nonummy nibh euismod tincidunt...</p>
						...
						<!-- Sidebar of the page -->
						<aside id="sidebar" class="col-xs-12 col-md-4 pull-left">
							<!-- Widget of the page -->
							...
							<div class="widget promo-widget wow fadeInUp" data-wow-delay="0.6s">
								<a href="#"><img src="images/ad-placeholder.jpg" alt="“Place your Advertisement here”"></a>
							</div>
							<!-- Widget of the page end -->
							<!-- Widget of the page -->
