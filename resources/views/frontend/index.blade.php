				...
				<div class="switcher-mask">
						...
						<div class="switcher-slide">
							<div class="slide-holder">
								<div class="img-holder">
									<img src="{{asset('/frontend')}}/images/img02.jpg" alt="image description">
								</div>
								<h2><a href="single-post.html">Letter from the desk of an <br>unsuccessful designer</a></h2>
					...
					<div class="slide">
						<div class="switcher-slide">
							<div class="slide-holder">
								<div class="img-holder">
									<img src="{{asset('/frontend')}}/images/img03.jpg" alt="image description">
								</div>
								<h2><a href="single-post.html">Letter from the desk of an <br>unsuccessful designer</a></h2>
								<time datetime="2011-01-12"><a href="#">2nd january, 2016</a></time>
							</div>
					...
					<div class="slide">
						<div class="switcher-slide">
							<div class="slide-holder">
								<div class="img-holder">
									<img src="{{asset('/frontend')}}/images/img04.jpg" alt="image description">
								</div>
								<h2><a href="single-post.html">Letter from the desk of an <br>unsuccessful designer</a></h2>
								<time datetime="2011-01-12"><a href="#">2nd january, 2016</a></time>
							</div>
					...
					<div class="slide">
						<div class="switcher-slide">
							<div class="slide-holder">
								<div class="img-holder">
									<img src="{{asset('/frontend')}}/images/img05.jpg" alt="image description">
								</div>
								<h2><a href="single-post.html">Letter from the desk of an <br>unsuccessful designer</a></h2>
								<time datetime="2011-01-12"><a href="#">2nd january, 2016</a></time>
							</div>
			...
			<div class="row">
				...
				<div id="content" class="col-xs-12 col-md-8">
					...
					<div class="cols-holder">
						...
						<article class="post wow fadeInLeft" data-wow-delay="0.6s">
							<div class="img-holder"><a href="single-post.html"><img src="{{asset('/frontend')}}/images/img06.jpg" alt="image description"></a></div>
							<div class="text-wrap">
						...
						<article class="post wow fadeInRight" data-wow-delay="0.6s">
							<div class="img-holder"><a href="single-post.html"><img src="{{asset('/frontend')}}/images/img07.jpg" alt="image description"></a></div>
							<div class="text-wrap">
								<time datetime="2011-01-12">25th May - <a href="#">Travel</a></time>
					...
					<div class="cols-holder">
						...
						<article class="post fluid text-center wow fadeInUp" data-wow-delay="0.6s">
							<div class="video-holder">
								...
								<img src="{{asset('/frontend')}}/images/img72.jpg" alt="image description">
							</div>
					...
					<div class="cols-holder">
						<!-- post of the page -->
						<article class="post wow fadeInLeft" data-wow-delay="0.6s">
							<div class="img-holder"><a href="single-post.html"><img src="{{asset('/frontend')}}/images/img08.jpg" alt="image description"></a></div>
							<div class="text-wrap">
								<time datetime="2011-01-12">25th May - <a href="#">Travel</a></time>
						...
						<!-- post of the page -->
						<article class="post wow fadeInRight" data-wow-delay="0.6s">
							<div class="img-holder"><a href="single-post.html"><img src="{{asset('/frontend')}}/images/img09.jpg" alt="image description"></a></div>
							<div class="text-wrap">
					...
					<div class="cols-holder">
						...
						<article class="post fluid text-center wow fadeInUp" data-wow-delay="0.6s">
							<ul class="list-unstyled carousel">
								<li>
									<div class="slide">
										<img src="{{asset('/frontend')}}/images/img10.jpg" alt="image description">
									</div>
								</li>
								<li>
									<div class="slide">
				...
				<aside id="sidebar" class="col-xs-12 col-md-4">
					...
					<div class="widget promo-widget wow fadeInUp" data-wow-delay="0.6s">
						<a href="#"><img src="{{asset('/frontend')}}/images/ad-placeholder.jpg" alt="“Place your Advertisement here”"></a>
					</div>
					<!-- Widget of the page end -->
					<!-- Widget of the page -->
	...
	<div class="instagram-slider container-fluid">
		<div class="row">
			<div class="mask">
				<div class="slideset">
					<div class="slide">
						<a href="#"><img src="{{asset('/frontend')}}/images/img30.jpg" alt="image description"></a>
					</div>
					<div class="slide">
						<a href="#"><img src="{{asset('/frontend')}}/images/img31.jpg" alt="image description"></a>
					</div>
					<div class="slide">
						<a href="#"><img src="{{asset('/frontend')}}/images/img35.jpg" alt="image description"></a>
					</div>
					<div class="slide">
						<a href="#"><img src="{{asset('/frontend')}}/images/img32.jpg" alt="image description"></a>
					</div>
					<div class="slide">
						<a href="#"><img src="{{asset('/frontend')}}/images/img33.jpg" alt="image description"></a>
					</div>
					<div class="slide">
						<a href="#"><img src="{{asset('/frontend')}}/images/img36.jpg" alt="image description"></a>
					</div>
					<div class="slide">
						<a href="#"><img src="{{asset('/frontend')}}/images/img34.jpg" alt="image description"></a>
					</div>
					<div class="slide">
						<a href="#"><img src="{{asset('/frontend')}}/images/img30.jpg" alt="image description"></a>
					</div>
