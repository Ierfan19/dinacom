            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="main-header">
                        <strong class="title">Wisata</strong>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div id="content" class="col-xs-12 col-md-8">
                    ...
                    <div class="widget widget_search hidden-md hidden-lg">
                        <form method="get" class="search-form" action="{{ url('/wisata') }}">
                            <fieldset>
                            ...
                            <article class="post-block wow fadeInUp" data-wow-delay="0.6s">
                                <div class="post-holder">
                                    <div class="img-holder">
                                        <a href="{{ url('/wisata') }}/{{ $row->nama }}"><img
                                                src="{{ asset('/') }}{{ $row->gambar }}" alt="image description"></a>
                                    </div>
                                    {{-- <time datetime="2011-01-12"><a href="#">25th May - Travel</a></time> --}}
                                    <h2><a href="{{ url('/wisata') }}/{{ $row->nama }}">{{ $row->nama }}</a></h2>
                                    <p>{{ $row->nama }}</p>
                                    <a href="{{ url('/wisata') }}/{{ $row->nama }}" class="read-more">Read more</a>
                                    {{-- <footer>
