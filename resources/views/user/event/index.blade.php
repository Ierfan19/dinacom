            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{asset('/')}}{{$row->gambar}}" width="200" style="object-fit: cover;height:200px;" alt="">
                        </td>
                        <td>
                            {{$row->nama}}
                        </td>
                        ...
                        <td>
                            <a href="javascript:;" onclick="edit('{{$row->id}}')" class="btn btn-primary">Edit</a>
                            <a onclick="return confirm('Apa Anda Yakin??')" href="{{url('/user/event/hapus/')}}/{{$row->id}}" class="btn btn-danger">Hapus</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
