                    ...
                    <tbody>
                        @foreach ($produk as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('user.produk.edit', ['id' => Crypt::encrypt($row->id)]) }}"
                                        class="btn btn-primary">Edit</a>
                                    <a href="{{ route('user.produk.slide', ['id' => Crypt::encrypt($row->id)]) }}"
                                        class="btn btn-secondary">Slide Gambar</a>
                                    <a onclick="return confirm('Apa Anda Yakin??')"
                                        href="{{ url('/user/produk/hapus/') }}/{{ $row->id }}"
